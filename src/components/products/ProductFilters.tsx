    ...
    <div className="flex flex-col gap-8">
      <label className="relative block">
        ...
        <input
          ...
          className="w-full rounded-full border border-brand-border bg-brand-surface py-3 pl-12 pr-4 text-sm text-brand-text placeholder:text-brand-text-secondary focus:border-brand-yellow"
        />
      </label>
