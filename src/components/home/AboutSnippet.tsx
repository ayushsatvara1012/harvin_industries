...
function FacilityVisual() {
  return (
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-0 -translate-x-4 bg-brand-yellow clip-notch-left" />
      ...
      <div className="relative h-full w-full overflow-hidden bg-brand-ink clip-notch-left">
        ...
        <div className="absolute inset-x-0 bottom-0 bg-brand-ink/85 backdrop-blur-[2px] px-6 py-3.5 pl-6 lg:pl-32">
          <div className="flex items-center justify-start gap-6 lg:gap-9">
            {PILLARS.map((pillar) => (
              <div key={pillar.label} className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-semibold leading-tight text-gray-100 max-w-[92px]">
                  {pillar.label}
                </span>
              </div>
            ))}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          <div className="lg:col-span-6 lg:py-10">
            ...
            <p className="mt-6 max-w-lg text-sm sm:text-[15px] text-brand-text-secondary leading-relaxed">
