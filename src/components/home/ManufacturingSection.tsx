      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="mt-5 text-sm text-brand-text-secondary leading-relaxed">
            ...
            {PROCESS_STEPS.map((step) => (
              <div key={step.title} className="group flex flex-col">
                ...
                <div className="flex flex-1 flex-col justify-between gap-2 pt-3 pb-1">
                  <h3 className="text-[11px] font-bold uppercase tracking-tight text-brand-text leading-[1.35] whitespace-pre-line">
                    {step.title}
                  </h3>
